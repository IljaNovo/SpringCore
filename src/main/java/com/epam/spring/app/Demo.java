...
// Проверить функционал на удачливый билет можно так: 1 - 5 раз перезапустить проект
// и если будет общая скидка 0.0 то билет оказался удачливым и стоит 0.0 рублей, но если
// не удачливый, то будет выведена общая скидка, отличная от 0.0 
...
public class Demo {
	public static void main(String[] args) {
		...
		System.out.println(
				"Общая скидка для пользователя " + customer.getName() + ": " + mdd.getSpecificDiscount(customer));
	}
}
